import{_ as s,c as a,o as n,V as p}from"./chunks/framework.nhQNVgJI.js";const g=JSON.parse('{"title":"影视","description":"","frontmatter":{},"headers":[],"relativePath":"guide/movie.md","filePath":"guide/movie.md","lastUpdated":1709955357000}'),e={name:"guide/movie.md"},l=p(`<h1 id="影视" tabindex="-1">影视 <a class="header-anchor" href="#影视" aria-label="Permalink to &quot;影视&quot;">​</a></h1><h2 id="cctv影视库" tabindex="-1">CCTV影视库 <a class="header-anchor" href="#cctv影视库" aria-label="Permalink to &quot;CCTV影视库&quot;">​</a></h2><p><strong>const baseURL = proxy + &#39;<a href="http://api.cntv.cn" target="_blank" rel="noreferrer">http://api.cntv.cn</a>&#39;</strong></p><h3 id="nav" tabindex="-1">NAV <a class="header-anchor" href="#nav" aria-label="Permalink to &quot;NAV&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>[</span></span>
<span class="line"><span>  {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,13),i=[l];function t(c,o,d,r,h,v){return n(),a("div",null,i)}const b=s(e,[["render",t]]);export{g as __pageData,b as default};
